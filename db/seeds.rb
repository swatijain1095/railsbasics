...
unless Fileexportemployee.blank?
  Fileexportemployee.create!(firstname: "Swati", lastname: "Patel", salary: 10000, notes: "Good Employee") 
  Fileexportemployee.create!(firstname: "Ravi", lastname: "Patel", salary: 20000, notes: "Good Employee")
  Fileexportemployee.create!(firstname: "Manish", lastname: "Patel", salary: 30000, notes: "Good Employee")
  Fileexportemployee.create!(firstname: "Rajesh", lastname: "Patel", salary: 40000, notes: "Good Employee")
  Fileexportemployee.create!(firstname: "Ramesh", lastname: "Patel", salary: 50000, notes: "Good Employee")
  Fileexportemployee.create!(firstname: "Suresh", lastname: "Patel", salary: 60000, notes: "Good Employee")
end